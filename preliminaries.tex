...
\newcommand{\aiusestatementpage}{%
  ...
  % TODO: short paragraph naming the AI tools used (e.g. ChatGPT,
  % Claude, GitHub Copilot, Cursor) and the overall philosophy
  % governing their use in this dissertation.
  AI tools were used frequently in the underlying research and the drafting of this thesis.
  In regards to the thesis particularly, they were used to accelerate my process for writing technical documents rather than automating it entirely.
  Unless otherwise attributed, every word and figure in this thesis was either created by me, or was prompted by me and was subject to my review, editing, and final approval.
  All mistakes and inaccuracies are my own.

  A brief overview of how tools were used in writing this thesis is provided in the table below.
  Models used were Claude Sonnet 4.6, Opus 4.6 and 4.7, and GPT 5.4 and 5.5.
  Agentic tools used were Claude Code, Cursor, and OpenClaw.
  ...
  \noindent\begin{tabularx}{\textwidth}{@{}
    ...
    Drafting prose
      & Med
      & Hand write section as a bullet point outline, prompt AI to expand outline into paragraphs, and edit results \\
    \addlinespace
    Copy editing
      & High
