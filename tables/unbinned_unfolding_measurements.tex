...
%
% Columns: Experiment | arXiv | Dimensions | Final State | Momentum Selection
%
...
\begin{table}
  \caption{%
    ...
    8-dimensional.
    Full phase-space definitions, including $\eta$ requirements, are given in
