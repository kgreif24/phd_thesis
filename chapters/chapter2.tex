...
The NNID calculation can be extended to accommodate event weights by scaling each jet's contribution to the likelihood in \Cref{eq:likelihood} by its weight, and replacing the nearest neighbor assignments $i(k)$ and $j(k)$ by their weighted analogues.
