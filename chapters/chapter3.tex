...
\section{Normalizing Flows and Generative Models}
\label{sec:flows}
...
%    - A well-calibrated model: P(Y=1 | f(x)=p) = p.
%    - Reliability diagrams, ECE (expected calibration error).
%    - Conformal prediction: coverage-guaranteed prediction sets
%      without distributional assumptions — emerging in HEP.
%    - Temperature scaling as a simple post-hoc calibration method.
%
