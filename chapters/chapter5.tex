...
Accurate unbinned of these observables had previously only been achieved with generative models by targeting them directly.Here they are unfolded to within 10\% accuracy.
...
It can also be understood as the limit of IBU as the bin width goes to zero.
...
If more iterations are required, the updated weights are pushed back to the detector-level simulation and Steps 1 and 2 repeat\footnote{Events that pass the detector-level event selection but fail the detector-level selection can be assigned the weight of the prior at this step as well}.
