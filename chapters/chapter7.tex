...
\Cref{ch:tagging} presented a study of top quark tagging using low-level constituent inputs, which established that neural networks trained directly on low-level jet constituent kinematic information outperform those trained on expert-engineered summary features, mirroring the lessons learned from the AlexNet moment in the computer vision field.
